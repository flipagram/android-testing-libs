...
/**
 * An activity displaying a list with large rows
 */
public class TallRowListActivity extends Activity {
  ...
  public void onCreate(Bundle bundle) {
    ...
    populateData();
    setContentView(R.layout.tall_row_list_activity);
    ...
    ListAdapter adapter = new SimpleAdapter(this, data, R.layout.tall_row_list_item, from, to) {
      @Override
      public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
          convertView = layoutInflater.inflate(R.layout.tall_row_list_item, null);
        }
    ...
    View footerView = layoutInflater.inflate(R.layout.tall_row_list_item, listView, false);
